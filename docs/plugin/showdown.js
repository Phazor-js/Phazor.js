...
(function () {
            ...
            if (i.listeners) {
                ...
                for (var c in i.listeners)
                    if (i.listeners.hasOwnProperty(c) && "function" != typeof i.listeners[c])
                        return (n.valid = !1), (n.error = o + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + c + " must be a function but " + typeof i.listeners[c] + " given"), n;
            }
            if (i.filter) {
        ...
        do {
            for (n = 0; (o = d.exec(e)); )
                if (p.test(o[0])) n++ || (i = (s = d.lastIndex) - o[0].length);
                    ...
                    var _ = { left: { start: i, end: s }, match: { start: s, end: o.index }, right: { start: o.index, end: l }, wholeMatch: { start: i, end: l } };
    ...
    (a.helper.matchRecursiveRegExp = function (e, r, t, a) {
        ...
        (a.helper.replaceRecursiveRegExp = function (e, r, t, n, s) {
            ...
            if (u > 0) {
                ...
                for (var p = 0; p < u; ++p)
                    d.push(r(e.slice(i[p].wholeMatch.start, i[p].wholeMatch.end), e.slice(i[p].match.start, i[p].match.end), e.slice(i[p].left.start, i[p].left.end), e.slice(i[p].right.start, i[p].right.end))),
        ...
        a.subParser("anchors", function (e, r, t) {
            ...
            var n = function (e, n, s, o, i, l, c) {
                ...
                return (
                    "" !== c && null !== c && (u += ' title="' + (c = (c = c.replace(/"/g, "&quot;")).replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'),
    ...
    a.subParser("autoLinks", function (e, r, t) {
        ...
        a.subParser("escapeSpecialCharsWithinTagAttributes", function (e, r, t) {
            "use strict";
            return (
                (e = (e = t.converter._dispatch("escapeSpecialCharsWithinTagAttributes.before", e, r, t)).replace(/<\/?[a-z\d_:-]+(?:[\s]+[\s\S]+?)?>/gi, function (e) {
        ...
        a.subParser("images", function (e, r, t) {
            ...
            function n(e, r, n, s, o, i, l, c) {
                ...
                return (
                    c && a.helper.isString(c) && (h += ' title="' + (c = c.replace(/"/g, "&quot;").replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'),
        ...
        a.subParser("lists", function (e, r, t) {
            ...
            function n(e, n) {
                ...
                var s = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0| {0,3}([*+-]|\d+[.])[ \t]+))/gm,
                    o = /\n[ \t]*\n(?!¨0)/.test((e += "¨0"));
                return (
                    r.disableForced4SpacesIndentedSublists && (s = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0|\2([*+-]|\d+[.])[ \t]+))/gm),
                ...
                if (-1 !== e.search(l))
                    !(function r(u) {
                        var d = u.search(l),
                            p = s(e, t);
                        -1 !== d
                            ? ((c += "\n\n<" + t + p + ">\n" + n(u.slice(0, d), !!a) + "</" + t + ">\n"), (l = "ul" === (t = "ul" === t ? "ol" : "ul") ? o : i), r(u.slice(d)))
                            : (c += "\n\n<" + t + p + ">\n" + n(u, !!a) + "</" + t + ">\n");
                    })(e);
                else {
                    var u = s(e, t);
        ...
        a.subParser("stripLinkDefinitions", function (e, r, t) {
            ...
            var n = function (e, n, s, o, i, l, c) {
                return (
                    ...
                    l ? l + c : (c && (t.gTitles[n] = c.replace(/"|'/g, "&quot;")), r.parseImgDimensions && o && i && (t.gDimensions[n] = { width: o, height: i }), "")
                );
            };
            return (
                (e = (e += "¨0").replace(
